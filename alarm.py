...
YTDLP_COOKIES_FILE = os.getenv("YTDLP_COOKIES_FILE", os.path.join(BASE_DIR if 'BASE_DIR' in dir() else os.path.dirname(os.path.abspath(__file__)), "www.youtube.com_cookies.txt"))
